...
final case class CustomerServiceLive(dataSource: DataSource) extends CustomerService{
  ...
  override def populateCustomerDb(): Task[Unit] = {
    val customers = List(Customer(1, "Hassan", "Hassan@gmail.com"), Customer(2, "Yassine", "Yassine@gmail.com"), Customer(4, "Aicha", "Aich@gmail.com"),Customer(3, "Mohamed", "mohamed@gmail.com"))
    run {
      quote {
